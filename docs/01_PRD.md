...
| 11 | mingxingtu5 | mingxingtu5 | text | AI短劇 | ai_drama | 既有 |
| 12 | aiduanjuji | aiduanjuji | text | AI短劇 | ai_drama | **新增** |
| 13 | dyvv9 | dyvv9 | text | 吃瓜爆料 | guaba_bl | 既有 |
...
### F17 分頁載入（v3.2 改為數字分頁）

- 每頁 50 筆（圖片/影片/訊息卡片）
- 底部顯示數字頁碼導航：← 上一頁 | 1 2 3 ... N | 下一頁 →
- 當前頁碼高亮顯示
- 顯示總筆數「共 N 筆」
- 每個頁籤獨立分頁狀態
- 搜尋模式下暫停分頁，顯示所有符合結果
